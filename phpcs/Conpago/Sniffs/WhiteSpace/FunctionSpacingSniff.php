<?php
class Conpago_Sniffs_WhiteSpace_FunctionSpacingSniff implements PHP_CodeSniffer_Sniff
{
        ...
        */
        ...
        if ($nextLineToken === ($phpcsFile->numTokens - 1)) {
            ...
            if ($nextContent === false) {
                ...
                // should be done by an EOF sniff.
                $foundLines = $this->spacing;
            } else if ($tokens[$nextContent]['type'] == 'T_CLOSE_CURLY_BRACKET') {
                // We are just before another block close.
                // Don't check spacing after the function because this
                // should be ommited.
                $foundLines = $this->spacing;
            } else {
